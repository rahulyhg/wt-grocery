...
<html> 
    ...
    <body>
		...
		<div class="how_to_use"  style="height:70px;width:290px;position:fixed;margin:10px;bottom:40px;font-weight:bold;background-color:FFF8DC;text-align:center;padding-top:20px;">
			<a href="video_editing4.html" target="_blank" style="color: inherit;text-decoration: none;">Don't know how to use the product ?</a>
		</div>
        <h1>Cooking Oil</h1>    
        <div class="content">
            <!-- content here -->
            <div class="product-grid product-grid--flexbox">
                <div class="product-grid__wrapper">
                    ...
                    <?php
                        ...
                        $query = 'SELECT * FROM products WHERE product_type="co"';
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo '<div class="product-grid__product">';
                                    ...
                                    echo '<div class="product-grid__extend-wrapper">';
                                        ...
                                        echo '<form method="post" action=cooking_oil.php?action=add&id='.$row["product_id"].'>';
                                            echo '<p class="product-grid__description_cooking">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis velit itaque odit.</p>
                                            <input type="submit" class="product-grid__btn product-grid__add-to-cart" value="Add to Cart">';echo "<script src='product_description4.js'></script>";					
                                        echo '</form>';
                                            echo '</div>';
                                    echo '</div>';
                                echo '</div>';
