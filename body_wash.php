...
<html> 
    ...
    <body>
		...
		<div class="how_to_use"  style="height:70px;width:290px;position:fixed;margin:10px;bottom:40px;font-weight:bold;background-color:FFF8DC;text-align:center;padding-top:20px;">
			<a href="video_editing2.html" target="_blank" style="color: inherit;text-decoration: none;">Don't know how to use the product ?</a>
		</div>
        <h1>Body Wash</h1>    
        <div class="content">
            <!-- content here -->
            <div class="product-grid product-grid--flexbox">
                <div class="product-grid__wrapper">
                    ...
                    <?php
                        ...
                        $query = 'SELECT * FROM products WHERE product_type="bw"';
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo '<div class="product-grid__product">';
                                    ...
                                    echo '<div class="product-grid__extend-wrapper">';
                                        ...
                                        echo '<form method="post" action=body_wash.php?action=add&id='.$row["product_id"].'>';
                                            echo '<p class="product-grid__description_body">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis velit itaque odit.</p>
                                            <input type="submit" class="product-grid__btn product-grid__add-to-cart" value="Add to Cart">';echo "<script src='product_description1.js'></script>";			
                                        echo '</form>';
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
